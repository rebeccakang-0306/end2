...
var submitRate = async (req, res) => {
    ...
    try{
        let item = {
            ...
            Muzzle1:req.body.Muzzlue1,
            Muzzle2:req.body.Muzzlue2,
            Muzzle3:req.body.Muzzlue3,
            Muzzle4:req.body.Muzzlue4,
            Muzzle5:req.body.Muzzlue5,
            Muzzle6:req.body.Muzzlue6,
