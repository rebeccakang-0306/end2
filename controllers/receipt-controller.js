...
var submitRate = async (req, res) => {
    ...
    try{
        let item = {
            ...
            Muzzlue1:req.body.Muzzlue1,
            Muzzlue2:req.body.Muzzlue2,
            Muzzlue3:req.body.Muzzlue3,
            Muzzlue4:req.body.Muzzlue4,
            Muzzlue5:req.body.Muzzlue5,
            Muzzlue6:req.body.Muzzlue6,
